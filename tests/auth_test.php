...
class auth_enrolkey_auth_testcase extends advanced_testcase {
    ...
    public function test_add_cohorts_during_signup() {
        ...
        $cohortmapping = new \auth_enrolkey\persistent\enrolkey_cohort_mapping(0, (object) $cdata);
        $cohortmapping->save();
        ...
        $availableenrolids = [1];
        \auth_enrolkey\persistent\enrolkey_cohort_mapping::add_cohorts_during_signup($user1, $availableenrolids);
