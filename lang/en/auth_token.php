...
$string['auth_tokensignup_view'] = 'Token enrolment';
$string['auth_tokensignup_view_message_basic'] = 'You have enrolled into {$a->course} as a {$a->role}.';
$string['auth_tokensignup_view_message_basic_dates'] = 'You have enrolled into {$a->course} as a {$a->role}.<br />Course start date: {$a->startdate}<br />Course end date: {$a->enddate}';
$string['auth_tokensignup_view_message_basic_dates_startonly'] = 'You have enrolled into {$a->course} as a {$a->role}.<br />Course start date: {$a->startdate}.';
$string['auth_tokensignup_view_message_basic_dates_endonly'] = 'You have enrolled into {$a->course} as a {$a->role}.<br />Course end date: {$a->enddate}.';
